...
import { TodoComponent } from './compoenents/todo.component';
...
export class AppComponent implements OnInit, AfterViewInit{
  ...
  // allows you to see childclass
  @ViewChild(TodoComponent)
  todoComp!: TodoComponent

  // not an angular component, just a regular component
  @ViewChild('clearBtn')
  clearBtn!: ElementRef
  ...
  newTodo(todo: Todo) {
    // (to update in AppComponent.component.html)
    console.info('in new Todo') // update the app.component.html
    console.info('>>>>>', todo) 
  }

  processTodo() {
    // (to update in AppComponent.component.html)
    console.info('in process Todo') // update the app.component.html
    this.data = this.todoComp.value()
    this.todoComp.clearForm()
    console.info('in process todo: ', this.data)
    this.clearBtn.nativeElement.innerText = `${this.data.name} - ${this.data.email}` // html
